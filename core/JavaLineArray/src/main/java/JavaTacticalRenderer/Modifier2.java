...
//                    }
    ...
    /**
     * Function to replace AddModifiers for most clients. The additional converter parameter
     * enables better accuracy locating the modifiers. Do  not deprecate AddModifers for clients which still use it.
     * @param tg
     * @param g2d
     * @param clipBounds
     * @param converter 
