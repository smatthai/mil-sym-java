            ...
            Rectangle2D clipRect)
    {
        ...
        try
        {
            ...
            {   
                ...
                {   //return array of one dummy shapespec
...
//            }
    ...
    /**
     * For CPOF clients in click-drag mode the points may be so close together that
     * there is not enough distance in pixels to draw a glyph. This function filters the
     * points to create enough pixels distance between successive point to allow drawing glyphs.
     * The function preserves the first and last symbol client points.
     * @param tg
     */
    ...
    /**
     * Adjusts 2nd point and subsequent points if necessary so that the control point is not behind it.
     * i.e. the control point is not further from the front of the symbol than the 2nd point.
     * @param tg
     * @param converter
     * @param usas
     */
    ...
    /**
     * @deprecated
     * May implement this function if METOCs get post clipped
     * @param pts2
     * @return
     */
