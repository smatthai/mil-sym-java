...
//                    }
            ...
            if (lineType == TacticalLines.RECTANGULAR || lineType == TacticalLines.PBS_RECTANGLE || lineType == TacticalLines.PBS_SQUARE) {
                ...
                if (AM.size() <= 2) //need to set the buffer to 0 if the client did not set it.
                {
                    tg.set_H1("0");   //buffer
                }
            }
...
//            tg.set_N(ModifiersTG.N_HOSTILE);
    ...
    /**
     * @deprecated Render the symbol and set ShapeInfo data in the client symol
     * @param symbol
     * @param converter
     */
    ...
    /**
     * @deprecated Added this public interface so that TestJavaLineArray can
    ...
    private static void GetLineArray(TGLight tg,
        ...
        try {
            ...
            //Modifier2.AddModifiers2RevD(tg);
...
//    }
     ...
     * TestJavaLineArray thru SECRenderer This is the public interface for
     * Google Earth renderer assumes tg.Pixels is filled assumes the caller
     * instantiated the ShapeInfo arrays
     *
     * @param tg tactical graphic
...
//            }
    ...
    /**
     * @deprecated public render function added primarily for METOCs because at
